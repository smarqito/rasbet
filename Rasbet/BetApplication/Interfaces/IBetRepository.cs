...
public interface IBetRepository
{
    ...
    Task<BetSimple> CreateBetSimple(double amount, DateTime start, string user, Selection selection, double serOdd);
    Task<BetMultiple> CreateBetMultiple(double amount, DateTime start, string user, double oddMultiple, ICollection<Selection> selections);
